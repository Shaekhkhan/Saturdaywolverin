...
public class Exception_tryCatchefinal {
	...
	*/
	...
	public static void main(String[] args) {
		//Built-in-Exception - ArrayIndexOutofBoundsExeption
		
	try{
		int[]ageGroup = new int[]{25, 32, 38, 50, 56};
	...
	try{
		...
		System.out.println("please enter a valid number");   // Note : I used to try catch finally blocked handle the java Exception
		e.printStackTrace();
